...
namespace csharpFramework.Network
{
	...
	public class TCPSocketListener
	{
        ...
        /** \brief Method that starts SocketListener Thread.
         */ 
        ...
        /** \brief Thread method that does the communication to the client. This 
        ...
        /** \brief Method that stops Client SocketListening Thread.
         */ 
        ...
        /** \brief Method that returns the state of this object i.e. whether this
		 * object is marked for deletion or not.
         *  \return true for marked for deletion, false is not 
         */ 
